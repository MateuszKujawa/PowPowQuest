...
import type { MiniQuizProps } from "./types";
import {
  QUESTIONS,
  TIME_LIMIT,
  FEEDBACK_DURATION,
...
const Stage2_MiniQuiz = ({ onComplete }: MiniQuizProps) => {
  ...
  const handleAnswer = (answerId: string) => {
    ...
    if (selectedAnswer.isCorrect) {
      ...
      setFeedback(
        isLastQuestion
          ? FEEDBACK_MESSAGES.quizComplete
      ...
      setFeedback(question.wrongFeedback);
        ...
        >
          ...
          <div className="backdrop-blur-2xl bg-white/8 border border-white/15 rounded-3xl p-6 mb-6 shadow-2xl">
            ...
            >
              ...
              <h1 className="text-xl text-white font-semibold leading-relaxed">
                {question.question}
              </h1>
            </motion.div>
          </div>
...
export default Stage2_MiniQuiz;
